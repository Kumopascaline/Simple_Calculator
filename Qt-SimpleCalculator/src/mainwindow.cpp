...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow) {
    ...
    ui->setupUi(this);
    setWindowTitle("Calculator (Normal)");
...
void MainWindow::CreateSimpleCalcWidget() {
    ...
    QString StyleSheetNumbers = "QPushButton { color: white; background-color: black; border-style: outset;border-width:2x;border-radius:6px;border-color:red;min-width: 10px;padding:6px ;font: 20pt 'Microsoft YaHei UI'; outline: none;} QPushButton:hover { background-color: #D8D8D8; border-style: solid; border-width: 3px;border-syle:inset; border-color: #F2F2F2; } QPushButton:pressed { background-color: #A4A4A4; border-style: solid; border-width: 3px; border-color: #E6E6E6; }";
    QString StyleSheetSigns =   "QPushButton { color: blue; background-color: black; border-style: outset;border-width:2x;border-radius:8px;border-color:red; font: 24pt 'Microsoft YaHei UI Light'; outline: none; } QPushButton:hover { background-color: #2ECCFA; border-style: solid; border-width: 3px; border-color: #58D3F7; } QPushButton:pressed { background-color: #81DAF5; border-style: solid; border-width: 3px; border-color: #A9E2F3; }";
...
void MainWindow::CreateComplCalcWidget() {
    ...
    QString StyleSheetSpecSigns = "QPushButton {max-width: 77px; color: red; background-color: black; border-style: outset;border-width:2x;border-radius:8px;border-color:grey; font: 14pt 'Microsoft YaHei UI Light'; outline: none; } QPushButton:hover { background-color: #D8D8D8; border-style: solid; border-width: 3px; border-color: #E6E6E6; } QPushButton:pressed { background-color: #A4A4A4; border-style: solid; border-width: 3px; border-color: #E6E6E6; }";
    QString StyleSheetSpecRoot =  "QPushButton {max-width: 77px; color: black; background-color: grey; border-style: outset;border-width:2x;border-radius:8px;border-color:grey; font: 16pt 'Microsoft YaHei UI Light'; outline: none; } QPushButton:hover { background-color: #D8D8D8; border-style: solid; border-width: 3px; border-color: #E6E6E6; } QPushButton:pressed { background-color: #A4A4A4; border-style: solid; border-width: 3px; border-color: #E6E6E6; }";
...
void MainWindow::CreateDefaultCalcWidget() {
    ...
    QPushButton* pushButtonClear =     new QPushButton(QString::fromUtf8("C"), this);
     QPushButton* pushButtonHistory =     new QPushButton(QString::fromUtf8("History"), this);

    QString StyleSheetBackSpace = "QPushButton { color: black; background-color: #E6E6E6; border-style: outset;border-width:2x;border-radius:8px; font: 20pt 'Microsoft YaHei UI Light'; outline: none; } QPushButton:hover { background-color: #D8D8D8; border-style: solid; border-width: 3px; border-color: #E6E6E6; } QPushButton:pressed { background-color: #A4A4A4; border-style: solid; border-width: 3px; border-color: #E6E6E6; }";
    QString StyleSheetHistory = "QPushButton { color: black; background-color: #E6E6E6; border-style: outset;border-width:2x;border-radius:8px; font: 12pt 'Microsoft YaHei UI Light'; outline: none; } QPushButton:hover { background-color: #D8D8D8; border-style: solid; border-width: 3px; border-color: #E6E6E6; } QPushButton:pressed { background-color: #A4A4A4; border-style: solid; border-width: 3px; border-color: #E6E6E6; }";
    QString StyleSheetClear =     "QPushButton { color: black; background-color: #E6E6E6; border-style: outset;border-width:2x;border-radius:8px; font: 20pt 'Microsoft YaHei UI'; outline: none; } QPushButton:hover { background-color: #D8D8D8; border-style: solid; border-width: 3px; border-color: #E6E6E6; } QPushButton:pressed { background-color: #A4A4A4; border-style: solid; border-width: 3px; border-color: #E6E6E6; }";
   ...
   pushButtonHistory->setStyleSheet(      StyleSheetHistory);
    ...
    defaultCalcLayout->addWidget(pushButtonHistory,     2, 5, 2, 1);
    ...
    connect(pushButtonHistory, SIGNAL(clicked()), this, SLOT(History()));
}
 ...
 database conn;
    ...
    if(!conn.connOpen()){
        ...
        return;
         ...
         conn.connOpen();
        QSqlQuery qry;
         qry.prepare("insert into  answer_storage (Answers) values('"+Answer+"')");
        if(qry.exec())
        {
            QMessageBox::critical(this,tr("Saved"),tr("answer is saved"));
            conn.connClose();
        }
        else{
